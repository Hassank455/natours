...
exports.resetPassword = catchAsync(async (req, res, next) => {
  ...
  // here we get the hashed version of the token from the url to compare with the hashed version of the token in the database
...
exports.updatePassword = catchAsync(async (req, res, next) => {
  ...
  user.passwordConfirm = req.body.passwordConfirm;
  await user.save();
  // we cannot use findByIdAndUpdate() to update the password because the pre save middleware will not work
