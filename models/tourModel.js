    ...
    guides: [
      {
        ...
        // ref coming from userModel.js => const User = mongoose.model('User', userSchema);
        ref: 'User',
      },
    ],
  },
...
tourSchema.virtual('reviews', {
  ref: 'Review',
  // the other model where we reference this model
  foreignField: 'tour',
  // the field in this model that is referenced
  localField: '_id',
});

// Document Middleware: runs before .save() and .create()
// naming is -> pre save hook OR pre save middleware
